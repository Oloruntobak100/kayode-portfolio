        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
              ...
              >
                <button
                  ...
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center group"
                >
                  Contact Me
                  <motion.svg
                ...
                <a
                  href="#portfolio"
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-primary-600 rounded-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-primary-200 flex items-center justify-center group"
                  onClick={(e) => {
                    e.preventDefault();
            ...
            <motion.div
              ...
              className="relative w-full lg:w-1/2 h-[400px] lg:h-[600px] hidden lg:flex items-center justify-center"
            >
              ...
              <motion.div
                ...
                className="relative w-[350px] sm:w-[450px] h-[350px] sm:h-[450px] rounded-full overflow-hidden border-4 border-white/10 shadow-2xl"
              >
                <img
                  src={profileImage}
